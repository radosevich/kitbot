...
public class RunIntake extends Command {
  ...
  public RunIntake(Intake intake1, Intake intake2) {
    // save the launcher system internally
    m_highintake = intake1;
    m_lowintake = intake2;

    // indicate that this command requires the launcher system
    addRequirements(m_highintake, m_lowintake);
  }
  ...
  public void initialize() {
    ...
    double kHighIntakeSpeed = -1; 
    double kLowIntakeSpeed = 1;
    m_highintake.sethighintake(kHighIntakeSpeed);
    m_lowintake.setlowintake(kLowIntakeSpeed);
  }
